...
function S230() {
  ...
  const handlecalculate2 =(e)=>{
      setshutterwidth2(((width-10)/2).toFixed(2))
      setshutterheight2(height-56)
      setinterlockheight2(height-56)
      setglasswidth2 ((((width-10.5)/2)-78).toFixed(2))
      setglassheight2 ((height-56)-78)
  }
  ...
  const handlecalculate3=(e)=>{
      setshutterwidth3(((parseInt(width)+39)/3).toFixed(2))
      setshutterheight3(height-53)
      setinterlockheight3(height-53)
      setglasswidth3((((parseInt(width)+39)/3)-78).toFixed(2))
      setglassheight3((height-53)-78)
  }
  ...
  const handlecalculate4=(e)=>{
      setshutterwidth4(((parseInt(width)+34)/4).toFixed(2))
      setshutterheight4(height-56)
      setinterlockheight4(height-56)
      setmatingsection4(height-77)
      setglasswidth4((((parseInt(width)+34)/4)-78).toFixed(2))
      setglassheight4((height-56)-78)
  }
  ...
  const handlecalculate6=(e)=>{
      setshutterwidth6(((parseInt(width)+128)/6).toFixed(2))
      setshutterheight6(height-56)
      setinterlockheight6(height-56)
      setmatingsection6(height-77)
      setglasswidth6((((parseInt(width)+128)/6)-78).toFixed(2))
      setglassheight6((height-56)-78)
  }
        ...
        <div className='box'>
            <div className='inner-box'>
                ...
                <div className='carousel'>
                    ...
                    <Table  className={`table-text ${display2}`} style={{borderCollapse:'separate',borderSpacing:'70px 22px',fontWeight:'bolder'}} >
                    <tr>
                        <th></th>
                        <th></th>
                        <th>Pcs</th>
