...
function S280() {
  ...
  const handlecalculate2 =(e)=>{
      setshutterwidth2(((width-10.5)/2).toFixed(2))
      setshutterheight2(height-73)
      setinterlockheight2(height-73)
      setglasswidth2 ((((width-10.5)/2)-100).toFixed(2))
      setglassheight2 ((height-73)-100)
  }
  ...
  const handlecalculate3=(e)=>{
      setshutterwidth3(((parseInt(width)+49)/3).toFixed(2))
      setshutterheight3(height-73)
      setinterlockheight3(height-73)
      setglasswidth3((((parseInt(width)+49)/3)-105).toFixed(2))
      setglassheight3((height-73)-105)
  }
  ...
  const handlecalculate4=(e)=>{
      setshutterwidth4(((parseInt(width)+42)/4).toFixed(2))
      setshutterheight4(height-73)
      setinterlockheight4(height-73)
      setmatingsection4(height-98)
      setglasswidth4((((parseInt(width)+42)/4)-100).toFixed(2))
      setglassheight4((height-73)-105)
  }
  ...
  const handlecalculate6=(e)=>{
      setshutterwidth6(((parseInt(width)+163)/6).toFixed(2))
      setshutterheight6(height-73)
      setinterlockheight6(height-73)
      setmatingsection6(height-98)
      setglasswidth6((((parseInt(width)+163)/6)-105).toFixed(2))
      setglassheight6((height-73)-105)
  }
